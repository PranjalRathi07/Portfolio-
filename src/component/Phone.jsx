...
export default function PhoneMockup() {
	...
	return (
		<div className='relative w-full py-10 flex items-center justify-center z-10' ref={containerRef}>
			{/* Background glow */}
			...
			<div className='relative perspective-[1400px]'>
				...
				<div 
					...
					style={{ transformStyle: 'preserve-3d', transition: 'transform 0s linear' }}>
							...
							<div className='relative z-10 px-6 pt-20 pb-6 text-white'>
								...
								<div className='mt-5 grid grid-cols-2 gap-4'>
									<div className='rounded-[1.6rem] border border-white/5 bg-[linear-gradient(180deg,rgba(20,24,34,0.9),rgba(8,10,16,0.95))] px-5 py-6 shadow-[inset_0_1px_0_rgba(255,255,255,0.04)]'>
										...
										<div className='mt-2 text-[10px] sm:text-xs tracking-[0.1em] text-white/40'>
											AVG LATENCY
										</div>
									</div>
