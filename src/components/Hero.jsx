    ...
    <>
      ...
      <section className="relative z-20 -mt-[100vh] w-full bg-transparent px-6 pb-44 font-sans">
        <div className="flex flex-col items-center justify-center">
          <p className="text-[#9ca3af] text-xl md:text-[26px] max-w-225 text-center font-light leading-relaxed tracking-wide relative">
          ...
          <div className="mt-12 flex flex-wrap justify-center items-center gap-6 md:gap-10 text-[16px] md:text-[18px] text-[#9ca3af] relative">
            <div className="flex items-center gap-2.5">
              ...
              <span className="font-bold text-white">50+</span> Projects
            </div>
