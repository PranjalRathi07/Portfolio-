...
const Contact = () => {
  return (
    ...
    >
      ...
      <div className="flex flex-col md:flex-row gap-4 w-full max-w-300 items-center justify-center">
        {/* --- WHATSAPP CARD --- */}
        <a
          href="https://wa.me/7302368443"
          target="_blank"
          rel="noopener noreferrer"
          className="group relative w-full max-w-150 bg-[#111111] border border-white/5 rounded-3xl p-6 md:p-8 flex items-center justify-between transition-all duration-300 hover:scale-[1.02] hover:border-[#25D366]/30 shadow-[0_0_50px_rgba(37,211,102,0.05)] hover:shadow-[0_0_80px_rgba(37,211,102,0.15)]"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="group relative w-full max-w-150 bg-[#111111] border border-white/5 rounded-3xl p-6 md:p-8 flex items-center justify-between transition-all duration-300 hover:scale-[1.02] hover:border-[#0077B5]/30 shadow-[0_0_5	0px_rgba(0,119,181,0.05)] hover:shadow-[0_0_80px_rgba(0,119,181,0.15)]"
        >
          <div className="flex items-center gap-6">
            {/* Linkden Circle */}
