...
const Services = () => {
  ...
  const projects = [
    ...
    },
    {
      title: "Sample - 2",
      image: cover2,
      link: "https://landing-page-nine-lime-63.vercel.app",
    },
    {
      title: "Sample - 3",
      image: cover3,
      ...
      >
        ...
        <div className="px-6 md:px-12 lg:px-24 w-full relative z-10">
          ...
          <div className="flex flex-col md:flex-row md:justify-between items-start md:items-end mb-16 md:mb-24">
            ...
            <div className="mt-8 md:mt-0 text-[#888888] text-sm md:text-base max-w-70 md:text-right font-medium leading-relaxed">
