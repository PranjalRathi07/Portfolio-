...
const MarqueeStrip = () => {
  ...
  return (
    <section className="relative w-full h-30 sm:h-37.5 overflow-visible flex items-start justify-center z-20 -mt-5 sm:-mt-5">
	...
	bg-size-[40px_6px] bg-repeat-x"
        ></div>

        {/* Bottom oval dotted line */}
        <div
          className="absolute bottom-0 left-0 w-full s
	bg-[radial-gradient(ellipse,#2f6df6_40%,transparent_42%)]
	bg-size-[40px_6px] bg-repeat-x bg-bottom"
        ></div>
