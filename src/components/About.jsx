...
const About = () => {
  return (
    ...
    >
      ...
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 md:w-200 h-100 bg-[radial-gradient(ellipse_at_center,rgba(9,9,12,0.6)_0%,transparent_70%)] pointer-events-none"></div>

      {/* Main Card Container */}
      <div className="w-full max-w-300 bg-[#09090c] border border-white/4 rounded-[2.5rem] p-8 md:p-14 lg:p-20 flex flex-col lg:flex-row gap-12 lg:gap-20 items-center shadow-2xl shadow-black/50 hover:border-[#5a8ee2] transition-colors duration-300">
        {/* Left: Image Container */}
        <div className="relative w-full max-w-100 lg:w-[45%] aspect-4/5 rounded-3xl overflow-hidden shrink-0">
